...
var WardenOptions = []WardenOption{
	{
		Key: "prince", Name: "小王子", Category: "移动型",
		Description: "多个移动实体冲撞穿透敌人，留下延烧路径。击杀成长。",
		Color:       color.RGBA{R: 255, G: 140, B: 30, A: 255},
		AttackName:  "冲撞穿透", AttackDesc: "向敌群密集方向冲刺，穿透路径上所有敌人。",
		SpecialName: "火焰轨迹", SpecialDesc: "冲撞路径留下燃烧地带。(10/2s)",
		Tips:        []string{"强度 → 冲撞伤害 + 轨迹灼伤增强。", "适合密集小怪波次。"},
		Damage: "30", Interval: "3s", Speed: "600", AoE: "20", Duration: "2s", DoT: "10/s",
		GrowthKill: "+1 强度", GrowthWave: "+5 强度",
	},
	{
		Key: "core", Name: "战斗机甲", Category: "移动型",
	...
	{
		Key: "chain", Name: "能量串联", Category: "间接型",
	...
	{
		Key: "skystrike", Name: "天降", Category: "间接型",
		Description: "定时对敌群最密集区域发动AoE天降打击。",
		Color:       color.RGBA{R: 80, G: 200, B: 255, A: 255},
		AttackName:  "天降打击", AttackDesc: "锁定敌群最密集位置，释放范围打击。",
	...
	{
		Key: "envoy", Name: "使者", Category: "移动型",
		Description: "在塔之间跳跃附身，为宿主塔提供强度加成。不攻击敌人。",
		Color:       color.RGBA{R: 180, G: 120, B: 255, A: 255},
		AttackName:  "附身增强", AttackDesc: "选择周围敌人最多的塔附身，增强其伤害。",
		SpecialName: "智能跳跃", SpecialDesc: "优先附身射程内敌人最多的塔。",
		Tips:        []string{"不直接造成伤害。", "适合强力核心塔的辅助。"},
		Damage: "-", Interval: "-", Speed: "-", AoE: "-", Duration: "8s", DoT: "-",
