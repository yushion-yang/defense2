...
func defaultBalance() *BalanceConfig {
	return &BalanceConfig{
		...
		Items: []ItemBalance{
			{Kind: "baseDamage", Label: "攻击磨石", Boost: 2, Description: "基础伤害+{v}"},
			{Kind: "potentialDamage", Label: "攻击秘卷", Boost: 3, Description: "潜力伤害+{v}"},
			{Kind: "baseSpeed", Label: "速射齿轮", Boost: 0.15, Description: "基础攻速+{v}"},
			{Kind: "potentialSpeed", Label: "速射秘卷", Boost: 0.2, Description: "潜力攻速+{v}"},
			{Kind: "baseRange", Label: "瞄准镜片", Boost: 12, Description: "基础射程+{v}"},
			{Kind: "potentialRange", Label: "瞄准秘卷", Boost: 18, Description: "潜力射程+{v}"},
		},
