...
//
//go:embed config/levels/*.json config/towers/*.json config/enemies/*.json config/events/*.json config/hero/*.json config/wardens/*.json config/settings.json config/level-list.json
var DataFS embed.FS
