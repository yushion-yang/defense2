...
//
//go:embed config/levels/*.json config/towers/*.json config/enemies/*.json config/wardens/*.json config/abilities/*.json config/settings.json config/level-list.json config/balance.json config/ability_tests.json all:config/scenarios
var DataFS embed.FS
