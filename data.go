...
//
//go:embed config/levels/*.json config/towers/*.json config/enemies/*.json config/wardens/*.json config/abilities/*.json config/systems/*.json config/settings.json config/level-list.json config/balance.json all:config/scenarios config/llm/*.json
var DataFS embed.FS
