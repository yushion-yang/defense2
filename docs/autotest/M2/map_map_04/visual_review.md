...
### anomaly_wave_hp_regression_1675.png
![anomaly_wave_hp_regression_1675.png](anomaly_wave_hp_regression_1675.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_1827.png
![anomaly_build_silent_fail_1827.png](anomaly_build_silent_fail_1827.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_wave_hp_regression_2064.png
![anomaly_wave_hp_regression_2064.png](anomaly_wave_hp_regression_2064.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_warden_origin_stuck_2398.png
![anomaly_warden_origin_stuck_2398.png](anomaly_warden_origin_stuck_2398.png)
...
### anomaly_boss_too_weak_3713.png
![anomaly_boss_too_weak_3713.png](anomaly_boss_too_weak_3713.png)
