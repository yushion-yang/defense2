...
### anomaly_wave_hp_regression_1821.png
![anomaly_wave_hp_regression_1821.png](anomaly_wave_hp_regression_1821.png)
...
### anomaly_build_silent_fail_2189.png
![anomaly_build_silent_fail_2189.png](anomaly_build_silent_fail_2189.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_2550.png
![anomaly_build_silent_fail_2550.png](anomaly_build_silent_fail_2550.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_3615.png
![anomaly_boss_too_weak_3615.png](anomaly_boss_too_weak_3615.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_warden_origin_stuck_5728.png
![anomaly_warden_origin_stuck_5728.png](anomaly_warden_origin_stuck_5728.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_6734.png
![anomaly_boss_too_weak_6734.png](anomaly_boss_too_weak_6734.png)
