...
### anomaly_fps_drop_11.png
![anomaly_fps_drop_11.png](anomaly_fps_drop_11.png)
...
### anomaly_wave_hp_regression_1670.png
![anomaly_wave_hp_regression_1670.png](anomaly_wave_hp_regression_1670.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_1822.png
![anomaly_build_silent_fail_1822.png](anomaly_build_silent_fail_1822.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_wave_hp_regression_2194.png
![anomaly_wave_hp_regression_2194.png](anomaly_wave_hp_regression_2194.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_2200.png
![anomaly_build_silent_fail_2200.png](anomaly_build_silent_fail_2200.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_2570.png
![anomaly_build_silent_fail_2570.png](anomaly_build_silent_fail_2570.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_warden_origin_stuck_3448.png
![anomaly_warden_origin_stuck_3448.png](anomaly_warden_origin_stuck_3448.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_3657.png
![anomaly_boss_too_weak_3657.png](anomaly_boss_too_weak_3657.png)
