...
### leak_wave_7_1898.png
![leak_wave_7_1898.png](leak_wave_7_1898.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_8_2330.png
![leak_wave_8_2330.png](leak_wave_8_2330.png)
...
### leak_wave_9_2743.png
![leak_wave_9_2743.png](leak_wave_9_2743.png)
...
### leak_wave_10_3171.png
![leak_wave_10_3171.png](leak_wave_10_3171.png)
...
### leak_wave_13_4656.png
![leak_wave_13_4656.png](leak_wave_13_4656.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_10806.png
![anomaly_boss_too_weak_10806.png](anomaly_boss_too_weak_10806.png)
