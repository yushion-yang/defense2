...
### attack_wideBeam.png
![attack_wideBeam.png](attack_wideBeam.png)

**场景**: 攻击方式 'wideBeam' 首次开火时的战斗画面
...
### attack_scatter.png
![attack_scatter.png](attack_scatter.png)

**场景**: 攻击方式 'scatter' 首次开火时的战斗画面
...
3. 塔周围是否有异常的白色圆环 artifact？ _(ref: 旋刃白圈)_
4. 是否能看到伤害浮字（数字）出现在敌人身上？ _(ref: 电磁炮无伤害浮字)_
5. 散弹是否发射了多颗弹丸（而非单颗）？ _(ref: 散弹子弹数不增加)_
...
### status_slow.png
![status_slow.png](status_slow.png)

**场景**: 状态效果 'slow' 首次施加时的画面

**检查项**:
1. 状态效果的视觉标记是否可见（颜色叠加/粒子/图标）？
2. 受影响的敌人是否与未受影响的敌人有明显视觉区分？

### status_burn.png
![status_burn.png](status_burn.png)

**场景**: 状态效果 'burn' 首次施加时的画面
...
### status_bleed.png
![status_bleed.png](status_bleed.png)

**场景**: 状态效果 'bleed' 首次施加时的画面
...
### status_stun.png
![status_stun.png](status_stun.png)

**场景**: 状态效果 'stun' 首次施加时的画面
...
### anomaly_ability_silent_945.png
![anomaly_ability_silent_945.png](anomaly_ability_silent_945.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_10_3396.png
![leak_wave_10_3396.png](leak_wave_10_3396.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5107.png
![leak_wave_12_5107.png](leak_wave_12_5107.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5349.png
![leak_wave_12_5349.png](leak_wave_12_5349.png)
