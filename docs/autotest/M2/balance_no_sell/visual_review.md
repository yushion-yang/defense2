...
### anomaly_wave_hp_regression_2027.png
![anomaly_wave_hp_regression_2027.png](anomaly_wave_hp_regression_2027.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_3720.png
![anomaly_boss_too_weak_3720.png](anomaly_boss_too_weak_3720.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_6724.png
![anomaly_boss_too_weak_6724.png](anomaly_boss_too_weak_6724.png)
