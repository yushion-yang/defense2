...
### leak_wave_5_1459.png
![leak_wave_5_1459.png](leak_wave_5_1459.png)
...
### leak_wave_9_3056.png
![leak_wave_9_3056.png](leak_wave_9_3056.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_9_3071.png
![leak_wave_9_3071.png](leak_wave_9_3071.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_10_3176.png
![leak_wave_10_3176.png](leak_wave_10_3176.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_4898.png
![leak_wave_12_4898.png](leak_wave_12_4898.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_4905.png
![leak_wave_12_4905.png](leak_wave_12_4905.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5024.png
![leak_wave_12_5024.png](leak_wave_12_5024.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5215.png
![leak_wave_12_5215.png](leak_wave_12_5215.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5255.png
![leak_wave_12_5255.png](leak_wave_12_5255.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### leak_wave_12_5360.png
![leak_wave_12_5360.png](leak_wave_12_5360.png)
