...
### anomaly_build_silent_fail_943.png
![anomaly_build_silent_fail_943.png](anomaly_build_silent_fail_943.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_build_silent_fail_1304.png
![anomaly_build_silent_fail_1304.png](anomaly_build_silent_fail_1304.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_1561.png
![anomaly_boss_too_weak_1561.png](anomaly_boss_too_weak_1561.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_boss_too_weak_3655.png
![anomaly_boss_too_weak_3655.png](anomaly_boss_too_weak_3655.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_warden_origin_stuck_3911.png
![anomaly_warden_origin_stuck_3911.png](anomaly_warden_origin_stuck_3911.png)
