...
### anomaly_wave_hp_regression_2544.png
![anomaly_wave_hp_regression_2544.png](anomaly_wave_hp_regression_2544.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_economy_stall_2867.png
![anomaly_economy_stall_2867.png](anomaly_economy_stall_2867.png)
...
### anomaly_wave_hp_regression_3170.png
![anomaly_wave_hp_regression_3170.png](anomaly_wave_hp_regression_3170.png)
...
### anomaly_wave_hp_regression_4133.png
![anomaly_wave_hp_regression_4133.png](anomaly_wave_hp_regression_4133.png)

**检查项**:
1. 整体画面是否正常渲染（无全黑/全白/严重撕裂）？
2. UI 元素（顶栏、按钮）是否可见且布局正常？

### anomaly_wave_hp_regression_4700.png
![anomaly_wave_hp_regression_4700.png](anomaly_wave_hp_regression_4700.png)
