...
| `strategy_competent.go` | 542 | 仿真测试"合理玩家"策略。 |
...
| `adapter.go` | 214 | EffectResult → HitResult/TickResult 适配层。 |
...
| `stage.go` | 4452 | 游戏主战斗场景（~3600行，本项目最核心的文件）。 |
