...
| `fmt.Sprintf` | 61 | descriptor.Error, descriptor.String, descriptor.ValidateBlueprint, llm.BuildPrompt, llm.BuildStra... |
...
| `sb.WriteString` | 13 | llm.BuildPrompt, llm.BuildStrategicPrompt |
...
📍 `internal/core/tower/abilities/config_ability.go:20`

**调用 →**
- `config.LoadAbilityTable`
- `RegisterConfigAbilities`
...
📍 `internal/core/tower/abilities/config_ability.go:46`
...
### (*ConfigAbility) OnTick

📍 `internal/core/tower/abilities/config_ability.go:202`
...
📍 `internal/core/tower/abilities/config_ability.go:342`

**调用 →**
- `tower.Register`

**← 被调用**
- `abilities.InitConfigAbilities` (`internal/core/tower/abilities/config_ability.go`)
...
📍 `internal/core/aiplayer/aiplayer.go:71`
...
📍 `internal/core/aiplayer/decision.go:138`
...
📍 `internal/core/aiplayer/aiplayer.go:136`
...
📍 `internal/core/aiplayer/bubble.go:253`
...
📍 `internal/core/aiplayer/aiplayer.go:204`
...
📍 `internal/core/aiplayer/aiplayer.go:576`
...
📍 `internal/core/tower/descriptor/adapter.go:123`
...
**← 被调用**
- `scene.NewBlueprintEditScene` (`internal/scene/blueprint_edit.go`)
...
📍 `internal/core/tower/descriptor/edit_state.go:302`
...
📍 `internal/core/tower/descriptor/blueprint.go:55`
...
📍 `internal/core/tower/descriptor/init.go:45`
...
📍 `internal/core/tower/descriptor/descriptor.go:74`
...
📍 `internal/core/tower/descriptor/init.go:25`
...
📍 `internal/core/tower/descriptor/marshal.go:51`
...
📍 `internal/core/tower/descriptor/blueprint.go:77`
...
📍 `internal/core/enemy/movement.go:33`
...
📍 `internal/core/aiplayer/llm/prompt.go:83`
...
📍 `internal/core/aiplayer/llm/prompt.go:154`
...
📍 `internal/core/aiplayer/llm/connector.go:30`
...
📍 `internal/core/aiplayer/llm/connector.go:74`
...
📍 `internal/core/aiplayer/llm/prompt.go:49`
...
📍 `internal/core/aiplayer/llm/connector.go:249`
...
📍 `internal/core/aiplayer/llm/connector.go:114`
...
📍 `internal/core/aiplayer/llm/connector.go:164`
...
📍 `internal/core/aiplayer/llm/connector.go:93`
...
📍 `internal/scene/stage_info_vm.go:59`
...
📍 `internal/scene/tower_workshop.go:297`
...
📍 `internal/scene/test_select.go:338`
...
📍 `internal/scene/ability_edit.go:940`
...
📍 `internal/scene/stage_info_vm.go:503`
...
📍 `internal/scene/ability_edit.go:180`
...
📍 `internal/scene/test_select.go:123`
...
📍 `internal/scene/tower_workshop.go:92`
...
📍 `internal/scene/tower_workshop.go:129`
...
📍 `internal/scene/ability_edit.go:331`
...
📍 `internal/core/tower/upgrade.go:442`
...
📍 `internal/core/tower/tower.go:298`
...
📍 `internal/core/tower/upgrade.go:422`
...
📍 `internal/core/tower/tower.go:160`
...
📍 `internal/core/tower/upgrade.go:460`
...
📍 `internal/core/tower/ability.go:146`
...
📍 `internal/core/tower/tower.go:185`
...
📍 `internal/core/tower/ability.go:140`

**调用 →**
- `a.Name`

**← 被调用**
- `abilities.RegisterConfigAbilities` (`internal/core/tower/abilities/config_ability.go`)
- `descriptor.RegisterCustomAbilities` (`internal/core/tower/descriptor/init.go`)
- `descriptor.InitDescriptorAbilities` (`internal/core/tower/descriptor/init.go`)
...
📍 `internal/core/tower/tower.go:306`
