...
sfx('choice-appear', category='musical', duration=0.25, reverb_mix=0.05, layers=[
    {'type': 'harmonics', 'freq': 1000, 'freq_end': 1800, 'harmonics': 5, 'h_curve': 'bright', 'vol': 0.3, 'env': 'adsr', 'a': 0.02, 'd': 0.08, 's': 0.25, 'r': 0.08},
    {'type': 'sine', 'freq': 3000, 'vol': 0.08, 'env': 'exp', 'env_rate': 10},
])

sfx('choice-select', category='ui', duration=0.12, layers=[
    {'type': 'sine', 'freq': 1000, 'freq_end': 1500, 'vol': 0.35, 'env': 'exp', 'env_rate': 16},
    {'type': 'sine', 'freq': 2000, 'vol': 0.12, 'env': 'exp', 'env_rate': 22},
    {'type': 'harmonics', 'freq': 1500, 'freq_end': 2200, 'harmonics': 4, 'h_curve': 'bright', 'vol': 0.08, 'env': 'exp', 'env_rate': 14},
])
